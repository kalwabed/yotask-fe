import { Button, Container, Flex, FormControl, FormErrorMessage, FormLabel, Heading, Input, Text } from "@chakra-ui/react"
import ky from 'ky'
...
function App() {
  ...
  const login = async (data: { username: string; password: string }) => {
    try {
    const userLogin = await ky.post('http://localhost:8000/auth/login', {
      json: {
